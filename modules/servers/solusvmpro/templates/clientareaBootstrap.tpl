...
<div class="row">
    ...
    <div id="displaybandwidthbar" style="display: none">
        ...
        <div class="col-md-9 margin-top-20" id="displaybandwidthbarInfo">
            <span id="displaybandwidthbarInfoSpan1"></span> {$LANG.solusvmpro_of} <span id="displaybandwidthbarInfoSpan2"></span> {$LANG.solusvmpro_used} / <span
    ...
    <div id="displaymemorybar" style="display: none">
        ...
        <div class="col-md-9" id="displaymemorybarInfo">
            <span id="displaymemorybarInfoSpan1"></span> {$LANG.solusvmpro_of} <span id="displaymemorybarInfoSpan2"></span> {$LANG.solusvmpro_used} / <span
    ...
    <div id="displayhddbar" style="display: none">
        ...
        <div class="col-md-9" id="displayhddbarInfo">
            <span id="displayhddbarInfoSpan1"></span> {$LANG.solusvmpro_of} <span id="displayhddbarInfoSpan2"></span> {$LANG.solusvmpro_used} / <span
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row margin-10">
                                    ...
                                    <div class="col-xs-8">
                                        ...
                                        <button type="button" id="changerootpassword" class="btn btn-action">{$LANG.solusvmpro_change}</button>
                                    </div>
                                    <div class="col-xs-2"></div>
                                </div>
